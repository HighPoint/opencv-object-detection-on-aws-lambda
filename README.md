...
3) Select a photo. Either select one of the stock photos or upload your own. Select "Detect," if you upload your own image or change the image detection options.
